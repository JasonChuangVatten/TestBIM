...
function resize() {
    ...
    text_margins = { top: chart_y_pos + gauge_h + 20, right: 10, bottom: 0, left: 10 };
...
var max = 1200;
var result = roundTo((533 / max), 2); ;	// in a scale [0 1]
var resultPos = chart_w * result;

var text_margins = { top: chart_y_pos + gauge_h + 20, right: 10, bottom: 0, left: 10 };
